...
// End Cross Module References
	...
	DEFINE_FUNCTION(UMenu::execMenuSetup)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->MenuSetup(Z_Param_NumberOfPublicConnections,Z_Param_MatchOfType,Z_Param_LobbyPath);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMenu_MenuSetup_Statics::NewProp_MatchOfType = { "MatchOfType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Menu_eventMenuSetup_Parms, MatchOfType), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_MenuSetup_Statics::Function_MetaDataParams[] = {
		...
		{ "CPP_Default_NumberOfPublicConnections", "32" },
		{ "ModuleRelativePath", "Public/Menu.h" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMenu_HostButtonCLicked, "HostButtonCLicked" }, // 4074638332
		{ &Z_Construct_UFunction_UMenu_JoinButtonCLicked, "JoinButtonCLicked" }, // 3868439134
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 3321736694
	...
	struct Z_CompiledInDeferFile_FID_Carrier_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Carrier_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 4070751992U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Carrier_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_582131924(TEXT("/Script/MultiplayerSessions"),
		Z_CompiledInDeferFile_FID_Carrier_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Carrier_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
